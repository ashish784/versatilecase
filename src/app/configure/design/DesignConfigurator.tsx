...
const DesignConfigurator = ({ configId, imageUrl, imageDimensions }: DesignConfiguratorProps) => {
  ...
  const { mutate: saveConfig } = useMutation({
    ...
    const [rendedredDimension, setRenderedDimension] = useState({
    ...
    async function saveConfiguration() {
        try {
            ...
            ctx?.drawImage(
                ...
                actualX,
                actualY,
                rendedredDimension.width,
                rendedredDimension.height
            )
            ...
            toast({
                title: "Something went wrong",
                description: "There was a problem saving your cofig, please try again",
                variant: "destructive",
            })
          console.error(err);
        }
                    ...
                    <div className="mt-3 space-y-4">
                      {selectableOptions.map((option) => (
                        <RadioGroup.Option
                          ...
                          className={({ active, checked }) =>
                            cn(
                              "relative block cursor-pointer rounded-lg bg-white px-6 py-4 shadow-sm border-2 border-zinc-200 foucus:outline-none ring-0 focus:ring-0 outline-none sm:flex sm:justify-between",
