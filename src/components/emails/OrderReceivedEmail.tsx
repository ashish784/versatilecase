...
const OrderReceivedEmail = ({
    ...
    "http://localhost:3000" : "https://versatilecase.vercel.app"
                ...
                <Body style={main}>
                    <Container style={container}>
                        ...
                        <Text style={global.text}>
                            We're preparing everything for delivery and will notify you once your package has been shipped. Delivery usually takes a 5 days.
                        </Text>
                        <Text style={{...global.text, marginTop: 24}}>
                            If you have any questions regarding to your order,feel free to contact us with your order number and we're here to help.
                        </Text>
                    </Section>
                    <Hr style={global.hr} />
                ...
                <Section style={paddingY}>
                    ...
                    <Row>
                        <Text style={footer.text}>
                            &copy; VersatileCase, Inc, All Rights Reserved.
                        </Text>
                    </Row>
                </Section>
